...
//                        Logger.getLogger(HeadItem.class.getName()).log(Level.SEVERE, null, ex);
//                    }
//                }
//            }
//        });
...
//        });
    ...
    private void iniTest() {
        Image image = ImageBox.getImagePath("Resources/Images/Head/User/31.png", 40, 40);
        setHeadImage(image);
        this.setRemark("傻瓜式");
        this.setNickname("(asjasjkja哈哈哈)");
        this.setShowText("hhhddddddddd");
    }
    ...
    public void setPulse(boolean pulse) {
        if (!pulse && animation.getStatus() == Animation.Status.RUNNING) {
            animation.stop();
        } else {
            animation.play();
        }
