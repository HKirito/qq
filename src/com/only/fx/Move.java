...
public class Move {
    ...
    public void doMaximized() {
        if (null != titlePane) {
            titlePane.toogleMaximized();
        } else {
            toogleMaximized();
        }
    }
    ...
    public TitlePane getTitlePane(int i) {
        titlePane = new TitlePane(this, stage, i);
        return titlePane;
    }

    public TitlePane getTitlePane() {
        return Move.this.getTitlePane(1);
    }
}
